...
// Provider implements LLM interface for OpenAI
...
// New creates a new OpenAI provider using options pattern
...
func (p *Provider) convertToolsToFunctions(tools []interfaces.Tool) []openai.FunctionDefinition {
...
func (p *Provider) toolSchemaToJSON(schema interface{}) interface{} {
...
func (p *StreamingProvider) StreamTokensWithMetadata(ctx context.Context, prompt string) (<-chan TokenWithMetadata, error) {
