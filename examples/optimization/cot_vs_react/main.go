...
func main() {
	...
	// 初始化 LLM 客户端
	llmClient, err := providers.NewDeepSeekWithOptions(agentllm.WithAPIKey(apiKey), agentllm.WithModel("deepseek-chat"), agentllm.WithMaxTokens(2000), agentllm.WithTemperature(0.7))
	if err != nil {
